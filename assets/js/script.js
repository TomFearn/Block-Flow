...
function changeBackground(){
    ...
    if (pageColor === 'red'){
        ...
        root.style.setProperty('--bg-basic', 'linear-gradient(180deg, rgb(100% 100% 41.581%) 0%, rgb(77.248% 77.248% 32.12%) 6.25%, rgb(58.618% 58.618% 24.374%) 12.5%, rgb(43.581% 43.581% 18.121%) 18.75%, rgb(31.641% 31.641% 13.157%) 25%, rgb(22.34% 22.34% 9.289%) 31.25%, rgb(15.259% 15.259% 6.345%) 37.5%, rgb(10.011% 10.011% 4.163%) 43.75%, rgb(6.25% 6.25% 2.599%) 50%, rgb(3.664% 3.664% 1.523%) 56.25%, rgb(1.978% 1.978% 0.822%) 62.5%, rgb(0.954% 0.954% 0.397%) 68.75%, rgb(0.391% 0.391% 0.162%) 75%, rgb(0.124% 0.124% 0.051%) 81.25%, rgb(0.024% 0.024% 0.01%) 87.5%, rgb(0.002% 0.002% 0.001%) 93.75%, rgb(0% 0% 0%) 100% )')
    ...
    } else if(pageColor === 'teal'){
        root.style.setProperty('--bg-basic', 'linear-gradient(180deg, rgb(0% 50.196% 50.196%) 0%, rgb(0% 38.775% 38.775%) 6.25%, rgb(0% 29.424% 29.424%) 12.5%, rgb(0% 21.876% 21.876%) 18.75%, rgb(0% 15.882% 15.882%) 25%, rgb(0% 11.214% 11.214%) 31.25%, rgb(0% 7.659% 7.659%) 37.5%, rgb(0% 5.025% 5.025%) 43.75%, rgb(0% 3.137% 3.137%) 50%, rgb(0% 1.839% 1.839%) 56.25%, rgb(0% 0.993% 0.993%) 62.5%, rgb(0% 0.479% 0.479%) 68.75%, rgb(0% 0.196% 0.196%) 75%, rgb(0% 0.062% 0.062%) 81.25%, rgb(0% 0.012% 0.012%) 87.5%, rgb(0% 0.001% 0.001%) 93.75%, rgb(0% 0% 0%) 100% )')
